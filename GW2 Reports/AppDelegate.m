...
//  GW2 Reports
//
//  Created by Romain Talleu on 18/12/2014.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [GWKMatch matchWithMatchId:matchId callback:^(NSError *error, GWKMatch* object) {
        ...
        NSLog(@"Structure Blue Home : %@", object.blueMap.structuresDetails);
        NSLog(@"Structure Green Home : %@", object.greenMap.structuresDetails);
        NSLog(@"Structure Center Home : %@", object.centerMap.structuresDetails);
    }];
    return YES;
}
